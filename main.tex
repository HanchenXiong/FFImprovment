...
\title[Online Decision-making]{Online Decision-making with a Expert Committee and Its Application in FahsionFlow} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\frame{
    ...
    \begin{itemize} 
       ...
       \begin{figure}
        \includegraphics[width = 0.3\textwidth]{lines}
       \end{figure}
       \begin{enumerate}
...
%------------------------------------------------------------------------------------------
\section{New sku proposal plans in FashionFlow}
\frame{
    \Huge{New sku proposal plans in FahsionFlow}
}
...
\frame{
    ...
    \structure{References}: Nicolo Cesa-Bianchi and Gabor Lugosi. 2006. Prediction, Learning, and Games. Cambridge University Press, New York, NY, USA.
}
\begin{frame}
